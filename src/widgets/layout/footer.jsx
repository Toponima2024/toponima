          ...
          <div className="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
            <Link to="/explore/home" className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
              <button type="button" className="flex flex-col items-center">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Explore</span>
              </button>
            </Link>
            <Link to="/explore/home" className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
              <button type="button" className="flex flex-col items-center">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Collections</span>
              </button>
            </Link>
